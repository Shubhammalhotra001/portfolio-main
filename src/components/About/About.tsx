...
import SM_profile from "../../assets/SM_profile.png";
    ...
    <Container id="about">
      <div className="about-text">
        ...
        <ScrollAnimation animateIn="fadeInLeft" delay={0.1 * 1000}>
          <p>
            Welcome to my portfolio! I'm Shubham, a passionate Full Stack Developer
            dedicated to building seamless and scalable web applications.
      ...
      <div className="about-image">
        <ScrollAnimation animateIn="fadeInRight" delay={0.2 * 1000}>
          <img src={SM_profile} alt="Shubham Malhotra" />
        </ScrollAnimation>
      </div>
    </Container>
  );
